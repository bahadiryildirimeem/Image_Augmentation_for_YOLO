...
# sys.path.append('c:/users/bahadir/appdata/local/packages/pythonsoftwarefoundation.python.3.10_qbz5n2kfra8p0/localcache/local-packages/python310/site-packages')
# sys.path.insert(0, "..")
